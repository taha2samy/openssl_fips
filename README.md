...
**Wolfi OpenSSL FIPS** delivers **production-hardened**, **FIPS 140-3 compliant** OpenSSL 3.5.5 container images engineered for mission-critical environments where security, compliance, and auditability are non-negotiable.
...
| Feature | Standard Images | **Wolfi OpenSSL FIPS** |
|---------|----------------|----------------------|
...
| **Image Size** | 40-100MB+ | ✅ **distroless: N/A | standard: N/A** |
