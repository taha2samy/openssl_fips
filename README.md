...
docker pull ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0
...
# ==================================
FROM ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0 AS fips-openssl
...
services:
  openssl-fips:
    image: ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0
  ...
  template:
    ...
    spec:
      ...
      - name: fips-cert-generator
        image: ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0-distroless
...
```bash
# Using Trivy
trivy image ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0

# Using Grype
grype ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0

# Using Docker Scout
docker scout cves ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0
```
...
# Usage
verify_fips_openssl("ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0")
```
...
```bash
# Standard image
docker images ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0 --format "{{.Size}}"
# Output: ~25MB

# Distroless image
docker images ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0-distroless --format "{{.Size}}"
# Output: ~12MB

# Layer breakdown
docker history ghcr.io/taha2samy/wolfi-openssl-fips:3.4.0 --no-trunc
```
...
![GitHub Stars](https://img.shields.io/github/stars/taha2samy/wolfi-openssl-fips?style=social)
![GitHub Forks](https://img.shields.io/github/forks/taha2samy/wolfi-openssl-fips?style=social)
![GitHub Issues](https://img.shields.io/github/issues/taha2samy/wolfi-openssl-fips)
![GitHub PRs](https://img.shields.io/github/issues-pr/taha2samy/wolfi-openssl-fips)
